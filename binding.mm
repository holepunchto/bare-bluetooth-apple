...
static void
bare_bluetooth_apple_peripheral__on_services_discover(js_env_t *env, bare_bluetooth_apple_peripheral__on_services_discover_fn function, bare_bluetooth_apple_peripheral_ctx_t *ctx, bare_bluetooth_apple_peripheral_services_discover_t *event) {
...
static void
bare_bluetooth_apple_peripheral__on_characteristics_discover(js_env_t *env, bare_bluetooth_apple_peripheral__on_characteristics_discover_fn function, bare_bluetooth_apple_peripheral_ctx_t *ctx, bare_bluetooth_apple_peripheral_characteristics_discover_t *event) {
  BareBluetoothApplePeripheral *wrapper = ctx->peripheral;
  int err;
...
static void
bare_bluetooth_apple_peripheral__on_read(js_env_t *env, bare_bluetooth_apple_peripheral__on_read_fn function, bare_bluetooth_apple_peripheral_ctx_t *ctx, bare_bluetooth_apple_peripheral_read_t *event) {
  BareBluetoothApplePeripheral *wrapper = ctx->peripheral;
  int err;
...
static void
bare_bluetooth_apple_peripheral__on_write(js_env_t *env, bare_bluetooth_apple_peripheral__on_write_fn function, bare_bluetooth_apple_peripheral_ctx_t *ctx, bare_bluetooth_apple_peripheral_write_t *event) {
  BareBluetoothApplePeripheral *wrapper = ctx->peripheral;
  int err;
...
static void
bare_bluetooth_apple_peripheral__on_notify(js_env_t *env, bare_bluetooth_apple_peripheral__on_notify_fn function, bare_bluetooth_apple_peripheral_ctx_t *ctx, bare_bluetooth_apple_peripheral_notify_t *event) {
  BareBluetoothApplePeripheral *wrapper = ctx->peripheral;
  int err;
...
static void
bare_bluetooth_apple_peripheral__on_notify_state(js_env_t *env, bare_bluetooth_apple_peripheral__on_notify_state_fn function, bare_bluetooth_apple_peripheral_ctx_t *ctx, bare_bluetooth_apple_peripheral_notify_state_t *event) {
  BareBluetoothApplePeripheral *wrapper = ctx->peripheral;
  int err;
...
static void
bare_bluetooth_apple_peripheral__on_channel_open(js_env_t *env, bare_bluetooth_apple_peripheral__on_channel_open_fn function, bare_bluetooth_apple_peripheral_ctx_t *ctx, bare_bluetooth_apple_peripheral_channel_open_t *event) {
  BareBluetoothApplePeripheral *wrapper = ctx->peripheral;
  int err;
...
bare_bluetooth_apple_peripheral_init(
  ...
  @autoreleasepool {
    ...
    err = js_create_threadsafe_function<bare_bluetooth_apple_peripheral__on_services_discover, bare_bluetooth_apple_peripheral__on_finalize, bare_bluetooth_apple_peripheral_ctx_t, bare_bluetooth_apple_peripheral_services_discover_t>(env, onServicesDiscover, 0, 1, services_discover_ctx, handle->tsfn_services_discover);
    assert(err == 0);
    ...
    err = js_create_threadsafe_function<bare_bluetooth_apple_peripheral__on_characteristics_discover, bare_bluetooth_apple_peripheral__on_finalize, bare_bluetooth_apple_peripheral_ctx_t, bare_bluetooth_apple_peripheral_characteristics_discover_t>(env, onCharacteristicsDiscover, 0, 1, characteristics_discover_ctx, handle->tsfn_characteristics_discover);
    assert(err == 0);

    auto *read_ctx = new bare_bluetooth_apple_peripheral_ctx_t{(__bridge BareBluetoothApplePeripheral *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_peripheral__on_read, bare_bluetooth_apple_peripheral__on_finalize, bare_bluetooth_apple_peripheral_ctx_t, bare_bluetooth_apple_peripheral_read_t>(env, onRead, 0, 1, read_ctx, handle->tsfn_read);
    assert(err == 0);

    auto *write_ctx = new bare_bluetooth_apple_peripheral_ctx_t{(__bridge BareBluetoothApplePeripheral *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_peripheral__on_write, bare_bluetooth_apple_peripheral__on_finalize, bare_bluetooth_apple_peripheral_ctx_t, bare_bluetooth_apple_peripheral_write_t>(env, onWrite, 0, 1, write_ctx, handle->tsfn_write);
    assert(err == 0);

    auto *notify_ctx = new bare_bluetooth_apple_peripheral_ctx_t{(__bridge BareBluetoothApplePeripheral *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_peripheral__on_notify, bare_bluetooth_apple_peripheral__on_finalize, bare_bluetooth_apple_peripheral_ctx_t, bare_bluetooth_apple_peripheral_notify_t>(env, onNotify, 0, 1, notify_ctx, handle->tsfn_notify);
    assert(err == 0);
    ...
    err = js_create_threadsafe_function<bare_bluetooth_apple_peripheral__on_notify_state, bare_bluetooth_apple_peripheral__on_finalize, bare_bluetooth_apple_peripheral_ctx_t, bare_bluetooth_apple_peripheral_notify_state_t>(env, onNotifyState, 0, 1, notify_state_ctx, handle->tsfn_notify_state);
    assert(err == 0);
    ...
    err = js_create_threadsafe_function<bare_bluetooth_apple_peripheral__on_channel_open, bare_bluetooth_apple_peripheral__on_finalize, bare_bluetooth_apple_peripheral_ctx_t, bare_bluetooth_apple_peripheral_channel_open_t>(env, onChannelOpen, 0, 1, channel_open_ctx, handle->tsfn_channel_open);
    assert(err == 0);
...
static void
bare_bluetooth_apple_server__on_state_change(js_env_t *env, bare_bluetooth_apple_server__on_state_change_fn function, bare_bluetooth_apple_server_ctx_t *ctx, bare_bluetooth_apple_server_state_change_t *event) {
...
static void
bare_bluetooth_apple_server__on_add_service(js_env_t *env, bare_bluetooth_apple_server__on_add_service_fn function, bare_bluetooth_apple_server_ctx_t *ctx, bare_bluetooth_apple_server_add_service_t *event) {
  BareBluetoothAppleServer *server = ctx->server;
  int err;
...
static void
bare_bluetooth_apple_server__on_read_request(js_env_t *env, bare_bluetooth_apple_server__on_read_request_fn function, bare_bluetooth_apple_server_ctx_t *ctx, bare_bluetooth_apple_server_read_request_t *event) {
  BareBluetoothAppleServer *server = ctx->server;
  int err;
...
static void
bare_bluetooth_apple_server__on_write_requests(js_env_t *env, bare_bluetooth_apple_server__on_write_requests_fn function, bare_bluetooth_apple_server_ctx_t *ctx, bare_bluetooth_apple_server_write_requests_t *event) {
  BareBluetoothAppleServer *server = ctx->server;
  int err;
...
static void
bare_bluetooth_apple_server__on_subscribe(js_env_t *env, bare_bluetooth_apple_server__on_subscribe_fn function, bare_bluetooth_apple_server_ctx_t *ctx, bare_bluetooth_apple_server_subscribe_t *event) {
  BareBluetoothAppleServer *server = ctx->server;
  int err;
...
static void
bare_bluetooth_apple_server__on_unsubscribe(js_env_t *env, bare_bluetooth_apple_server__on_unsubscribe_fn function, bare_bluetooth_apple_server_ctx_t *ctx, bare_bluetooth_apple_server_unsubscribe_t *event) {
  BareBluetoothAppleServer *server = ctx->server;
  int err;
...
static void
bare_bluetooth_apple_server__on_ready_to_update(js_env_t *env, bare_bluetooth_apple_server__on_ready_to_update_fn function, bare_bluetooth_apple_server_ctx_t *ctx, void *data) {
  BareBluetoothAppleServer *server = ctx->server;
  int err;
...
static void
bare_bluetooth_apple_server__on_channel_publish(js_env_t *env, bare_bluetooth_apple_server__on_channel_publish_fn function, bare_bluetooth_apple_server_ctx_t *ctx, bare_bluetooth_apple_server_channel_publish_t *event) {
  BareBluetoothAppleServer *server = ctx->server;
  int err;
...
static void
bare_bluetooth_apple_server__on_channel_open(js_env_t *env, bare_bluetooth_apple_server__on_channel_open_fn function, bare_bluetooth_apple_server_ctx_t *ctx, bare_bluetooth_apple_server_channel_open_t *event) {
  BareBluetoothAppleServer *server = ctx->server;
  int err;
...
bare_bluetooth_apple_server_init(
  ...
  @autoreleasepool {
    ...
    err = js_create_threadsafe_function<bare_bluetooth_apple_server__on_state_change, bare_bluetooth_apple_server__on_finalize, bare_bluetooth_apple_server_ctx_t, bare_bluetooth_apple_server_state_change_t>(env, on_state_change, 0, 1, state_change_ctx, handle->tsfn_state_change);
    assert(err == 0);

    auto *add_service_ctx = new bare_bluetooth_apple_server_ctx_t{(__bridge BareBluetoothAppleServer *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_server__on_add_service, bare_bluetooth_apple_server__on_finalize, bare_bluetooth_apple_server_ctx_t, bare_bluetooth_apple_server_add_service_t>(env, on_add_service, 0, 1, add_service_ctx, handle->tsfn_add_service);
    assert(err == 0);

    auto *read_request_ctx = new bare_bluetooth_apple_server_ctx_t{(__bridge BareBluetoothAppleServer *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_server__on_read_request, bare_bluetooth_apple_server__on_finalize, bare_bluetooth_apple_server_ctx_t, bare_bluetooth_apple_server_read_request_t>(env, on_read_request, 0, 1, read_request_ctx, handle->tsfn_read_request);
    assert(err == 0);

    auto *write_requests_ctx = new bare_bluetooth_apple_server_ctx_t{(__bridge BareBluetoothAppleServer *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_server__on_write_requests, bare_bluetooth_apple_server__on_finalize, bare_bluetooth_apple_server_ctx_t, bare_bluetooth_apple_server_write_requests_t>(env, on_write_requests, 0, 1, write_requests_ctx, handle->tsfn_write_requests);
    assert(err == 0);

    auto *subscribe_ctx = new bare_bluetooth_apple_server_ctx_t{(__bridge BareBluetoothAppleServer *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_server__on_subscribe, bare_bluetooth_apple_server__on_finalize, bare_bluetooth_apple_server_ctx_t, bare_bluetooth_apple_server_subscribe_t>(env, on_subscribe, 0, 1, subscribe_ctx, handle->tsfn_subscribe);
    assert(err == 0);

    auto *unsubscribe_ctx = new bare_bluetooth_apple_server_ctx_t{(__bridge BareBluetoothAppleServer *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_server__on_unsubscribe, bare_bluetooth_apple_server__on_finalize, bare_bluetooth_apple_server_ctx_t, bare_bluetooth_apple_server_unsubscribe_t>(env, on_unsubscribe, 0, 1, unsubscribe_ctx, handle->tsfn_unsubscribe);
    assert(err == 0);

    auto *ready_to_update_ctx = new bare_bluetooth_apple_server_ctx_t{(__bridge BareBluetoothAppleServer *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_server__on_ready_to_update, bare_bluetooth_apple_server__on_finalize, bare_bluetooth_apple_server_ctx_t, void>(env, on_ready_to_update, 0, 1, ready_to_update_ctx, handle->tsfn_ready_to_update);
    assert(err == 0);

    auto *channel_publish_ctx = new bare_bluetooth_apple_server_ctx_t{(__bridge BareBluetoothAppleServer *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_server__on_channel_publish, bare_bluetooth_apple_server__on_finalize, bare_bluetooth_apple_server_ctx_t, bare_bluetooth_apple_server_channel_publish_t>(env, on_channel_publish, 0, 1, channel_publish_ctx, handle->tsfn_channel_publish);
    assert(err == 0);

    auto *channel_open_ctx = new bare_bluetooth_apple_server_ctx_t{(__bridge BareBluetoothAppleServer *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_server__on_channel_open, bare_bluetooth_apple_server__on_finalize, bare_bluetooth_apple_server_ctx_t, bare_bluetooth_apple_server_channel_open_t>(env, on_channel_open, 0, 1, channel_open_ctx, handle->tsfn_channel_open);
    assert(err == 0);
...
static void
bare_bluetooth_apple_central__on_state_change(js_env_t *env, bare_bluetooth_apple_central__on_state_change_fn function, bare_bluetooth_apple_central_ctx_t *ctx, bare_bluetooth_apple_central_state_change_t *event) {
...
static void
bare_bluetooth_apple_central__on_discover(js_env_t *env, bare_bluetooth_apple_central__on_discover_fn function, bare_bluetooth_apple_central_ctx_t *ctx, bare_bluetooth_apple_central_discover_t *event) {
  BareBluetoothAppleCentral *central = ctx->central;
  int err;
...
static void
bare_bluetooth_apple_central__on_connect(js_env_t *env, bare_bluetooth_apple_central__on_connect_fn function, bare_bluetooth_apple_central_ctx_t *ctx, bare_bluetooth_apple_central_connect_t *event) {
  BareBluetoothAppleCentral *central = ctx->central;
  int err;
...
static void
bare_bluetooth_apple_central__on_disconnect(js_env_t *env, bare_bluetooth_apple_central__on_disconnect_fn function, bare_bluetooth_apple_central_ctx_t *ctx, bare_bluetooth_apple_central_disconnect_t *event) {
  BareBluetoothAppleCentral *central = ctx->central;
  int err;
...
static void
bare_bluetooth_apple_central__on_connect_fail(js_env_t *env, bare_bluetooth_apple_central__on_connect_fail_fn function, bare_bluetooth_apple_central_ctx_t *ctx, bare_bluetooth_apple_central_connect_fail_t *event) {
  BareBluetoothAppleCentral *central = ctx->central;
  int err;
...
bare_bluetooth_apple_central_init(
  ...
  @autoreleasepool {
    ...
    err = js_create_threadsafe_function<bare_bluetooth_apple_central__on_state_change, bare_bluetooth_apple_central__on_finalize, bare_bluetooth_apple_central_ctx_t, bare_bluetooth_apple_central_state_change_t>(env, on_state_change, 0, 1, state_ctx, handle->tsfn_state_change);
    assert(err == 0);

    auto *discover_ctx = new bare_bluetooth_apple_central_ctx_t{(__bridge BareBluetoothAppleCentral *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_central__on_discover, bare_bluetooth_apple_central__on_finalize, bare_bluetooth_apple_central_ctx_t, bare_bluetooth_apple_central_discover_t>(env, on_discover, 0, 1, discover_ctx, handle->tsfn_discover);
    assert(err == 0);

    auto *connect_ctx = new bare_bluetooth_apple_central_ctx_t{(__bridge BareBluetoothAppleCentral *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_central__on_connect, bare_bluetooth_apple_central__on_finalize, bare_bluetooth_apple_central_ctx_t, bare_bluetooth_apple_central_connect_t>(env, on_connect, 0, 1, connect_ctx, handle->tsfn_connect);
    assert(err == 0);

    auto *disconnect_ctx = new bare_bluetooth_apple_central_ctx_t{(__bridge BareBluetoothAppleCentral *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_central__on_disconnect, bare_bluetooth_apple_central__on_finalize, bare_bluetooth_apple_central_ctx_t, bare_bluetooth_apple_central_disconnect_t>(env, on_disconnect, 0, 1, disconnect_ctx, handle->tsfn_disconnect);
    assert(err == 0);

    auto *connect_fail_ctx = new bare_bluetooth_apple_central_ctx_t{(__bridge BareBluetoothAppleCentral *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_central__on_connect_fail, bare_bluetooth_apple_central__on_finalize, bare_bluetooth_apple_central_ctx_t, bare_bluetooth_apple_central_connect_fail_t>(env, on_connect_fail, 0, 1, connect_fail_ctx, handle->tsfn_connect_fail);
    assert(err == 0);
...
static void
bare_bluetooth_apple_l2cap__on_data(js_env_t *env, bare_bluetooth_apple_l2cap__on_data_fn function, bare_bluetooth_apple_l2cap_ctx_t *ctx, bare_bluetooth_apple_l2cap_data_t *event) {
...
static void
bare_bluetooth_apple_l2cap__on_drain(js_env_t *env, bare_bluetooth_apple_l2cap__on_drain_fn function, bare_bluetooth_apple_l2cap_ctx_t *ctx, void *data) {
  BareBluetoothAppleL2CAPChannel *l2cap = ctx->l2cap;
  int err;
...
static void
bare_bluetooth_apple_l2cap__on_end(js_env_t *env, bare_bluetooth_apple_l2cap__on_end_fn function, bare_bluetooth_apple_l2cap_ctx_t *ctx, void *data) {
  BareBluetoothAppleL2CAPChannel *l2cap = ctx->l2cap;
  int err;
...
static void
bare_bluetooth_apple_l2cap__on_error(js_env_t *env, bare_bluetooth_apple_l2cap__on_error_fn function, bare_bluetooth_apple_l2cap_ctx_t *ctx, bare_bluetooth_apple_l2cap_error_t *event) {
  BareBluetoothAppleL2CAPChannel *l2cap = ctx->l2cap;
  int err;
...
static void
bare_bluetooth_apple_l2cap__on_close(js_env_t *env, bare_bluetooth_apple_l2cap__on_close_fn function, bare_bluetooth_apple_l2cap_ctx_t *ctx, void *data) {
  BareBluetoothAppleL2CAPChannel *l2cap = ctx->l2cap;
  int err;
...
static void
bare_bluetooth_apple_l2cap__on_open(js_env_t *env, bare_bluetooth_apple_l2cap__on_open_fn function, bare_bluetooth_apple_l2cap_ctx_t *ctx, void *data) {
  BareBluetoothAppleL2CAPChannel *l2cap = ctx->l2cap;
  int err;
...
bare_bluetooth_apple_l2cap_init(
  ...
  @autoreleasepool {
    ...
    err = js_create_threadsafe_function<bare_bluetooth_apple_l2cap__on_data, bare_bluetooth_apple_l2cap__on_finalize, bare_bluetooth_apple_l2cap_ctx_t, bare_bluetooth_apple_l2cap_data_t>(env, on_data, 0, 1, data_ctx, handle->tsfn_data);
    assert(err == 0);

    auto *drain_ctx = new bare_bluetooth_apple_l2cap_ctx_t{(__bridge BareBluetoothAppleL2CAPChannel *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_l2cap__on_drain, bare_bluetooth_apple_l2cap__on_finalize, bare_bluetooth_apple_l2cap_ctx_t, void>(env, on_drain, 0, 1, drain_ctx, handle->tsfn_drain);
    assert(err == 0);

    auto *end_ctx = new bare_bluetooth_apple_l2cap_ctx_t{(__bridge BareBluetoothAppleL2CAPChannel *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_l2cap__on_end, bare_bluetooth_apple_l2cap__on_finalize, bare_bluetooth_apple_l2cap_ctx_t, void>(env, on_end, 0, 1, end_ctx, handle->tsfn_end);
    assert(err == 0);

    auto *error_ctx = new bare_bluetooth_apple_l2cap_ctx_t{(__bridge BareBluetoothAppleL2CAPChannel *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_l2cap__on_error, bare_bluetooth_apple_l2cap__on_finalize, bare_bluetooth_apple_l2cap_ctx_t, bare_bluetooth_apple_l2cap_error_t>(env, on_error, 0, 1, error_ctx, handle->tsfn_error);
    assert(err == 0);

    auto *close_ctx = new bare_bluetooth_apple_l2cap_ctx_t{(__bridge BareBluetoothAppleL2CAPChannel *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_l2cap__on_close, bare_bluetooth_apple_l2cap__on_finalize, bare_bluetooth_apple_l2cap_ctx_t, void>(env, on_close, 0, 1, close_ctx, handle->tsfn_close);
    assert(err == 0);

    auto *open_ctx = new bare_bluetooth_apple_l2cap_ctx_t{(__bridge BareBluetoothAppleL2CAPChannel *) CFBridgingRetain(handle)};
    err = js_create_threadsafe_function<bare_bluetooth_apple_l2cap__on_open, bare_bluetooth_apple_l2cap__on_finalize, bare_bluetooth_apple_l2cap_ctx_t, void>(env, on_open, 0, 1, open_ctx, handle->tsfn_open);
    assert(err == 0);
